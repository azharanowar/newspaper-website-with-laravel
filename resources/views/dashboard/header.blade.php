...
<head>
    ...
    <!--plugins-->
    <link href="{{ asset('dashboardAssets') }}/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
    <link href="{{ asset('dashboardAssets') }}/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
    <link href="{{ asset('dashboardAssets') }}/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Bootstrap CSS -->
    ...
    <link rel="stylesheet" href="{{ asset('dashboardAssets') }}/assets/npm/bootstrap-icons%401.5.0/font/bootstrap-icons.css">
    ...
    <!--Theme Styles-->
    <link href="{{ asset('dashboardAssets') }}/assets/css/dark-theme.css" rel="stylesheet" />
    <link href="{{ asset('dashboardAssets') }}/assets/css/light-theme.css" rel="stylesheet" />
    <link href="{{ asset('dashboardAssets') }}/assets/css/semi-dark.css" rel="stylesheet" />
    <link href="{{ asset('dashboardAssets') }}/assets/css/header-colors.css" rel="stylesheet" />
